...
As a proof-of-principle, we study Z to ee samples from ATLAS Open-Data. An algorithm is setup to
...
uses a coarse 3 × 4 binning, the continuous method models the charge-misidentification probability as
...
sponse functions. It points toward a new paradigm for precision background estimation
