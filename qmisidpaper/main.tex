...
% ---------- Title ----------
\title{Learning Charge Misidentification Probabilities in Charged Particle Pair Production}

\author[1]{Jeremy J. H. Wilkinson}
\affil[1]{Cambridge University}

\author[2]{Christopher Lester}
\affil[2]{Cambridge University}

\author[3]{Alba Burgos Mondéjar}
\affil[3]{Cambridge University}
...
detector-response information that was previously inaccessible and enables a diﬀerential
description of QmisID eﬀects. The result is a practical framework that is continuous, 
high-dimensional, and data-driven. 
...
\input{sections/04_opendata}

\nocite{*} % TEMP: remove once inline \cite{} calls are added throughout the text
\printbibliography
